...
$(function () {
	...
	$("#sparkline5").sparkline([18, 22, 38, 20], {
        type: 'pie',
        height: '100',
        sliceColors: ['#3aa0dc', '#06d79c', '#745af2', '#ef5350'],
  ...
  function drawDocSparklines() {
    ...
    $('#compositebar').sparkline([7,3,10,5,4,8,6,4,2,4,5,3,4,5],
        {composite: true, fillColor: false, lineColor: '#ef5350'});
    ...
    $('#linecustom').sparkline('html',
        {
          height: '1.5em', width: '8em', lineColor: '#ef5350', fillColor: '#e9ab2e',
    ...
    $('#compositeline').sparkline([7,3,10,5,4,8,6,4,2,4,5,3,4,5],
        {composite: true, fillColor: false, lineColor: '#ef5350', changeRangeMin: 0, chartRangeMax: 10});
    ...
    $('#discrete2').sparkline('html',
        {type: 'discrete', lineColor: '#3aa0dc', thresholdColor: '#ef5350', thresholdValue: 4});
