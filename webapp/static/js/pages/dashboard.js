 ...
 // Get context with jQuery - using jQuery's .get() method.
		...
		var areaChartData = {
		  ...
		  datasets: [
			{
			  label               : 'Electronics',
			  fillColor           : 'rgba(57, 139, 247, 0.5)',
			  strokeColor         : 'rgba(30,172,190,0)',
			  pointColor          : 'rgba(57, 139, 247, 0.5)',
			...
			{
			  label               : 'Digital Goods',
			  fillColor           : 'rgba(249, 104, 104, 0.5)',
			  strokeColor         : 'rgba(38,198,218,0)',
			  pointColor          : '#06d79c',
			  pointStrokeColor    : 'rgba(249, 104, 104, 0.5)',
			  pointHighlightFill  : '#fff',
			  pointHighlightStroke: 'rgba(38,198,218,1)',
			  data                : [0, 5, 11, 2, 18, 10, 5, 11]
			}
		  ]
		}
